...
$(".add-to-basket-main").click(function() {
    ...
    setTimeout(function() {
        $(".modal-content-added").removeClass("show");
    }, 3000);
});
$(document).click(function(event) {
    //if you click on anything except the modal itself or the "open modal" link, close the modal
    if (!$(event.target).closest(".modal-content,.modal-content-size,.carousel-cell").length) // $('body').find(".modal").removeClass('show');
...
$("#5").click(function() {
    ...
    $(".style-title1").text("360\xb0 Super Skinny Jeans");
    ...
    $(".style-title4").text("360\xb0 Super Skinny Jeans");
...
//# sourceMappingURL=360.1f6869bf.js.map
